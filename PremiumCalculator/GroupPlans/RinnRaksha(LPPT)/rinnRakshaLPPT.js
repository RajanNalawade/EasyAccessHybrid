...
function initArrayList() {
    ...
    staffNonStaffListElement = document.forms["rinnRakshaLPPTForm"]["staff/nonstaff"];
    ...
    /* sourcedByListElement = document.forms["rinnRakshaLPPTForm"]["sourcedBy"];
    for (i = 0; i < sourcedByList.length; i++) {
        sourcedByListElement.add(new Option(sourcedByList[i].title, sourcedByList[i].value));
    } */

    loanTypeListElement = document.forms["rinnRakshaLPPTForm"]["loanType"];
    ...
    premPaidListElement = document.forms["rinnRakshaLPPTForm"]["premiumPaid"];
    ...
    //    document.forms["rinnRakshaLPPTForm"]["premiumFreqMode"].value = 'Yearly';

    premFreqModeElement = document.forms["rinnRakshaLPPTForm"]["premiumFreqMode"];
    ...
    moratoriumListElement = document.forms["rinnRakshaLPPTForm"]["Moratorium"];
    ...
    moratoriumPeriodListElement = document.forms["rinnRakshaLPPTForm"]["moratoriumPeriod"];
    for (i = minMoratoriumEducationLoan; i <= maxMoratoriumEducationLoan; i++) {
        moratoriumPeriodListElement.add(new Option(i));
    }

    interestPaymentListElement = document.forms["rinnRakshaLPPTForm"]["interestPayment"];
    for (i = 0; i < interestPaymentList.length; i++) {
        interestPaymentListElement.add(new Option(interestPaymentList[i].title, interestPaymentList[i].value))
    }

    optionListElement = document.forms["rinnRakshaLPPTForm"]["option"];
...
function onChangeLoanType() {
    ...
    if (loanType.title === 'Home Loan') {
        ...
        premFreqModeElement.value = "1";

        if (staff.title == 'Staff') {
            document.getElementById('divPremPayingterm').style.display = 'none';
        } else {
            document.getElementById('divPremPayingterm').style.display = 'block';
            document.getElementById('divPremPayingterm').value = '5';
        }
        ...
        document.getElementById('divCoBorrower').style.display = 'block';
        document.getElementById('divPremPayingterm').style.display = 'none';
        interestPaymentListElement = document.forms["rinnRakshaLPPTForm"]["loanSubCat"];
...
function setInterestRange() {
    ...
    interestRangeElement = document.forms["rinnRakshaLPPTForm"]["interestRate"];
...
function bindCoBorrowerOption(loanType) {
    coBorrowerOptionElement = document.forms["rinnRakshaLPPTForm"]["coBorrowerOption"];
...
function onCalculate() {
    ...
    if (rinnRakshaLPPTForm.checkValidity() &&
